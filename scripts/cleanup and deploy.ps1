...
New-NetIPAddress -IPAddress 172.21.240.1 -PrefixLength 24 -InterfaceIndex $NIC.ifIndex
New-NetNat -Name $swName -InternalIPInterfaceAddressPrefix "172.21.240.0/24" –Verbose
